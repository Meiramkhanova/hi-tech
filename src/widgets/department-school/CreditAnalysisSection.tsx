import { CreditAnalysis } from "@/entities/department-school/DepartmentSchool.t";
...
async function CreditAnalysisSection({
  projectDesc,
  financeDesc,
  riskManagementDesc,
  underwritingDesc,
  ...
  CreditAnalysis,
  "projectDesc" | "financeDesc" | "riskManagementDesc" | "underwritingDesc"
>) {
      ...
      <Container>
        <div className="wrapper flex flex-col gap-6 md:gap-8= pt-24">
          ...
          <div className="items-wrapper grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div
              className={cn(
                "underwriting-item rounded-2xl border items-center",
                "grid grid-cols-1 2xl:grid-cols-2 gap-6 md:gap-8 p-8"
              )}>
              <div className="item-icon-title flex items-center gap-6 md:gap-8">
                <div className="icon-item size-24 bg-theprimary/10 text-theprimary flex shrink-0 items-center justify-center rounded-2xl">
              ...
              <div className="item-desc font-light">{underwritingDesc}</div>
            </div>
          </div>
        </div>
      </Container>
